      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-gradient-to-br from-rose-500 to-pink-600 p-12 text-white">
        ...
        <div>
          <h1 className="text-4xl font-bold leading-tight">
            Join the<br />creator portal.
          </h1>
          <p className="mt-4 text-rose-100 text-lg">
            Get access to your campaigns, UTM links, discount codes, and payouts in one place.
          </p>
        </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12 bg-gray-50">
        <div className="w-full max-w-sm">
          <div className="mb-8 text-center lg:text-left">
            ...
            <h2 className="mt-1 text-2xl font-semibold text-gray-900">Create your account</h2>
            <p className="mt-1 text-sm text-gray-500">Set up your influencer portal access</p>
          </div>
